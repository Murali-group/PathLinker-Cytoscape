...
public class PathLinkerNodeSelectionListener implements RowsSetListener {
	...
	public void handleEvent(RowsSetEvent e) {
		...
		if (PathLinkerControlPanel._applicationManager.getCurrentNetworkView() == null || 
		        e.getSource() != PathLinkerControlPanel._applicationManager.getCurrentNetworkView().getModel().getDefaultNodeTable())
			return;
